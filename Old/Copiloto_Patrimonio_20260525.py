...
DEEPSEEK_INPUT_PRICE_PER_1M = float(os.getenv("DEEPSEEK_INPUT_PRICE_PER_1M", "0.0035"))
DEEPSEEK_OUTPUT_PRICE_PER_1M = float(os.getenv("DEEPSEEK_OUTPUT_PRICE_PER_1M", "0.83"))
...
CLIENT_FILES = {
    ...
    "proactivity_log": ACTIVE_CLIENT_DIR / "proactivity_log.md",
...
APP_STATE_FILE = ACTIVE_CLIENT_DIR / "app_state.json"

APP_TIMEZONE = os.getenv("APP_TIMEZONE", "Europe/Madrid")
PROACTIVE_SCHEDULER_HOUR = int(os.getenv("PROACTIVE_SCHEDULER_HOUR", "8"))
...
def load_app_state() -> dict:
    ...
    try:
        content = APP_STATE_FILE.read_text(encoding="utf-8").strip()
...
async def scheduled_run_followups(context: ContextTypes.DEFAULT_TYPE) -> None:
    """Daily automatic follow-up check."""
    chat_id = get_remembered_chat_id()
        ...
        append_text_file(
            ...
            "\n".join(
                [
                    ...
                    "### Scheduler",
                    "",
                    "No Telegram chat ID remembered yet. Automatic follow-ups were not sent.",
                    "",
                    "---",
                    "",
                ]
    ...
    append_text_file(
        ...
        "\n".join(
            [
                ...
                "### Scheduler",
                "",
                f"Automatic follow-up check completed.",
