...
Las skills extraen informaciÃ³n.
...
â†’ muestra riesgo 0â€“10
â†’ ofrece enviar o reducir riesgo
```
...
**Para quÃ© sirve:** hace visible la privacidad, evita envÃ­os inconscientes y crea confianza.
...
# Nueva Fase 7 â€” Skills extractoras

Las skills no son botones. Son funciones internas que reciben el texto del cliente y actualizan archivos o generan piezas de razonamiento.

## v30 â€” Skill: actualizar â€œquiÃ©n soy yoâ€

**Objetivo:** extraer del mensaje libre todo lo que pertenece al perfil del cliente.
...
```markdown
InformaciÃ³n nueva o corregida para quien_soy.md
```
...
## v31 â€” Skill: actualizar â€œquÃ© quieroâ€

**Objetivo:** extraer deseos, objetivos y prioridades.
...
## v32 â€” Skill: actualizar â€œquÃ© tengo que hacerâ€

**Objetivo:** convertir lo aprendido en acciones y decisiones pendientes.
...
## v33 â€” Skill: actualizar estilo de respuesta

**Objetivo:** aprender cÃ³mo debe hablar el sistema a ese cliente.
...
# Nueva Fase 8 â€” Skills tÃ©cnicas patrimoniales

## v34 â€” Skill: custodios y plataformas

**Objetivo:** ayudar a comparar dÃ³nde puede mantenerse o invertirse el dinero.
...
## v35 â€” Skill: estrategias patrimoniales generales

**Objetivo:** dado quiÃ©n es el cliente y quÃ© quiere, identificar rutas generales a comparar.
...
## v36 â€” Skill: preguntas para banco o asesor

**Objetivo:** generar preguntas concretas que el cliente debe hacer antes de aceptar una propuesta.
...
## v37 â€” Skill: lectura de documentos / posiciÃ³n actual
...
estilo_respuesta.md
Wealth_Knowledge/*.md
resultados de skills tÃ©cnicas
...
actualizaciones de archivos vivos
prÃ³xima acciÃ³n
...
3. El cliente elige enviar o reducir riesgo.
4. Las skills extraen informaciÃ³n.
5. Los archivos vivos se actualizan.
6. Las skills tÃ©cnicas analizan opciones, costes, plataformas o documentos.
7. El orquestador responde en el tono adecuado.
8. Los tres botones permiten ver:
   - quiÃ©n soy
   - quÃ© quiero
   - quÃ© tengo que hacer
9. Todo queda registrado.
```
...
Estas funciones deben existir como skills internas, no como interfaz:
